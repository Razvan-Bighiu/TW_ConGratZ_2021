...
background.src = "https://www.google.com/images/branding/googlelogo/1x/googlelogo_color_272x92dp.png";
var frame_img = new Image();
frame_img.src = "http://localhost/TW_CONGRATZ_2021/creator/frames/frame6.png";
...
function addFrame(frame_img) {
    frame_img.src = "./creator/frames/frame" + frame_img + ".png";
}

function _DrawImage() {
    context.drawImage(star_img, currentX - (star_img.width / 2), currentY - (star_img.height / 2));
    context.drawImage(frame_img, 0, 0);
}
...
function addBackground(background) {
    background.src = "./creator/stickers/background" + background + ".png";
}